...
import { deleteCategoryAdmin, getCatogoryAll, saveCategoryNew } from '../../actions/categoryAction';
...
const CategoryAdminScreen = (props) => {
    ...
    return <DashboardScreen > 
            ...
            <button className="btn btn-danger ab-right"  onClick={showModal }>Thêm Danh mục</button>
                <Modal title= { id ? "Cập nhật Danh mục" : "Thêm Danh mục" } visible={isModalVisible}   onCancel={handleCancel}>
            ...
            <div>
                ...
                <table className="table">
                    ...
                    categories && categories.data && categories.data.map((category,index)=>
                        ...
                        <td>
                            <button className="btn btn-success" onClick={() => openModal(category)} >Sửa</button>
                            <button className="btn btn-dark" onClick={() => deleteHandler(category)}>Xóa</button>
                        </td>
                    </tr>
