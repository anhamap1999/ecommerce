...
import { deleteProductCart, getProductCart, updateProductCart } from '../actions/cartActions';
...
function CartScreen(props) {
  ...
  return <HomePage>
    <div className="container cart-details">
            <div className="text-center"><h1>Giỏ hàng của bạn</h1></div>
    {
            ...
            <div className="col-md-8 col-12">
                    {
                      ...
                      cartItems.map( item =>
                        <div className="row yourcart">
                            ...
                            <div className="col-md-2">
                                 <InputNumber min={1} max={item.product_id.stock} 
                            ...
                            <div className="col-md-3">
                              <div>
                                ...
                                <span style={{fontSize : '18px',color:'#ee4d2d'}}>{item.product_id.price}VNĐ</span>
                                </div>
                            </div>
