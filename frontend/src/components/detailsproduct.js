              ...
              <div className="row" style={{padding: '0px 0 20px 15px'}}>
                <Breadcrumb>
                  ...
                  {category_parent && (
                    <Breadcrumb.Item>
                      <Link
                        to={'/products/' + category_parent.pure_name}
                        onClick={() =>
                          onClickItem('category_id', category_parent._id)
                        }
                      >
                  ...
                  <Breadcrumb.Item>
                    <Link
                      to={'/products/' + category_id.pure_name}
                      onClick={() =>
                        onClickItem('category_id', category_id._id)
                      }
                    >
                      {category_id.name}
                    </Link>
