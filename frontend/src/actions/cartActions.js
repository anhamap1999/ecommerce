import {DELETE_PRODUCT_CART_FAIL, DELETE_PRODUCT_CART_REQUEST, DELETE_PRODUCT_CART_SUCCESS, GET_PRODUCT_CART_FAIL, GET_PRODUCT_CART_REQUEST, GET_PRODUCT_CART_SUCCESS, SAVE_PRODUCT_CART_FAIL, SAVE_PRODUCT_CART_REQUEST, SAVE_PRODUCT_CART_SUCCESS, UPDATE_PRODUCT_CART_FAIL, UPDATE_PRODUCT_CART_REQUEST, UPDATE_PRODUCT_CART_SUCCESS} from '../constants/cartConstants'
import Cookie from 'js-cookie';
import axiosClient from "../modules/axios";
const saveProductCart =  ( {price,quantity,product_id,size})  => async ( dispatch,getState ) =>{
...
export { saveProductCart,getProductCart,deleteProductCart,updateProductCart}
