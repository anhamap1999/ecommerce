...
router.get('/admin', isAuth, isStaff, validator.getOrdersValidator, controller.getOrdersByAdmin);
router.put('/admin/:id', isAuth, isStaff, validator.createOrderValidator, controller.updateOrderByAdmin);
router.get('/:id', isAuth, controller.getOrderById);
router.post('/', isAuth, validator.createOrderValidator, controller.saveOrder);
router.put('/:id', isAuth, validator.updateOrderValidator, controller.updateOrder);
