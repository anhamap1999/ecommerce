...
router.post("/change-password", isAuth, validator.changePasswordValidator, controller.changePassword);
router.put("/update", isAuth, validator.updateUserValidator, controller.updateUser);
router.get("/admin", isAuth, isAdmin, validator.getUsersValidator, controller.getUsers);
